...
@Component({
  selector: 'app-inspection-test-edit',
  templateUrl: './inspection-test-edit.component.html',
  styleUrls: ['./inspection-test-edit.component.css']
})
export class InspectionTestEditComponent extends AppComponentBase implements OnInit {
    saving = false;
