...
{
    public abstract class eConLabWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static eConLabWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(eConLabWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<eConLabDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<eConLabDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<eConLabDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<eConLabDbContext, Task<T>> func)
        {
            T result;
