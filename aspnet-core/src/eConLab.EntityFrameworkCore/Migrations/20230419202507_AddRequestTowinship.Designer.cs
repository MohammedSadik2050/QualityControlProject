...
namespace eConLab.Migrations
{
    ...
    [Migration("20230419202507_AddRequestTowinship")]
    partial class AddRequestTowinship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eConLab.Account.Agency", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.Account.AgencyType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.Account.QCUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.Attachment.Attachments", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.Departments.Department", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.LookupModel.LookupApp", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.Observers.Observer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.ProjectModels.Project", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<DateTime>("SiteDelivedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<long>("SupervisingQualityId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("eConLab.ProjectModels.ProjectItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("eConLab.Req.Request", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("PhomeNumberSiteResponsibleOne")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PhomeNumberSiteResponsibleTwo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eConLab.WF.RequestWF", b =>
                {
                    ...
                    b.ToTable("RequestWFs");
                });

            modelBuilder.Entity("eConLab.WF.RequestWFHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("eConLab.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("eConLab.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("eConLab.Departments.Department", b =>
                {
                    b.HasOne("eConLab.Account.Agency", "Agency")
                        .WithMany()
            ...
            modelBuilder.Entity("eConLab.Req.Request", b =>
                {
                    b.HasOne("eConLab.Observers.Observer", "Observer")
                        .WithMany()
                        .HasForeignKey("ObserverId");

                    b.HasOne("eConLab.ProjectModels.Project", "Project")
                        .WithMany()
